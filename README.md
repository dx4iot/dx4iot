...
<!-- ═══════════════ COVER BANNER ═══════════════ -->
<img src="https://raw.githubusercontent.com/dx4iot/dx4iot/main/cover.svg" width="100%" alt="dx4iot cover"/>
...
└─$ cat about.txt
  ...
  Location : India
  Focus    : Web App Pentesting, Recon, OSINT
  Status   : Always Hunting
```

> **Security researcher** focused on bug bounty programs, web application pentesting, and ethical hacking. I believe in breaking things *legally* to make the internet safer.
>
> **Udemy Instructor** with **1 Lakh+ students** taught across Python, cybersecurity & programming.
>
> **Freelancer** building tools, doing security audits, and shipping code for global clients.
>
> **Multiple income streams** — bug bounties, trading, courses, and freelance projects run in parallel.
...
|---|---|---|
| **Bug Bounty** | HackerOne · Bugcrowd · Intigriti | `ACTIVE` |
| **Udemy Instructor** | Python · Cybersecurity · Hacking | `1L+ Students` |
| **Freelancing** | Security Audits · Dev Work · Tools | `OPEN` |
| **Trading** | Financial Markets | `RUNNING` |
| **Open Source** | Tools & Scripts | `BUILDING` |
